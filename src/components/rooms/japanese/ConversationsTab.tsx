...
import { jpConversation, jpShortcuts } from "@/lib/data/japanese";
    ...
    <div className="space-y-5 animate-[fadeInUp_0.4s_ease-out]">
      ...
      >
        <div className="mb-4 flex items-center gap-2 text-sm font-bold text-white">
          💬 {jpConversation.title}
        </div>
        <div className="space-y-3">
          {jpConversation.bubbles.map((b, i) => {
            const isMe = b.who === "me";
            return (
              <div
                key={i}
              ...
              >
                ...
                >
                  <button
                    ...
                    className="absolute -top-2.5 grid size-7 place-items-center rounded-full border transition-colors"
                    style={{
                      background: `${JP}33`,
                      borderColor: `${JP}66`,
                      color: JP,
                  ...
                  <div className="text-sm font-bold" style={{ color: JP }}>
                    {b.target}
                  </div>

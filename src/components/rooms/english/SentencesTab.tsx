...
import { enSentences } from "@/lib/data/english";
    ...
    <div className="space-y-4 animate-[fadeInUp_0.4s_ease-out]">
      {enSentences.map((s) => (
        <button
          ...
          className="relative block w-full rounded-2xl border bg-white/[0.04] p-5 text-start transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(52,152,219,0.15)]"
